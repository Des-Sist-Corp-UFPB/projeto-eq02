package br.ufpb.dsc.cirurgias;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * Classe principal da aplicação Cirurgias.
 *
...
public class CirurgiasApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(CirurgiasApplication.class, args);
    }
}
