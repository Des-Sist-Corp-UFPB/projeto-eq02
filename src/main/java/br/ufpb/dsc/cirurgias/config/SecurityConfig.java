package br.ufpb.dsc.cirurgias.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .formLogin(form -> form
                        ...
                        .loginPage("/login")
                        // Após login bem-sucedido, redireciona para a listagem de cirurgias
                ...
                .csrf(csrf -> csrf
                        // Desabilita CSRF para os endpoints da API para facilitar o teste no Postman/Insomnia
